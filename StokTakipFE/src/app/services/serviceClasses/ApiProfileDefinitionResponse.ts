export interface ApiProfileDefinitionResponse {
    objectSid: string;
    accountName: string;
    firstName: string;
    lastName: string;
...
export class ApiProfileDefinitionResponse implements ApiProfileDefinitionResponse {
    objectSid: string;
    accountName: string;
    firstName: string;
    lastName: string;
    ...
    constructor(o: ApiProfileDefinitionResponse) {
        if (!o || !o.objectSid) {
            return;
        }
